...
public class TestCustomerController {
    ...
    public void testGetSingleCustomerById() {
        Customer dataCustomer = customerRepository.searchCustomerById(customer.getId());
    ...
    public void testRemovingACustomer() {
        Customer findCustomer = customerRepository.searchCustomerById(customer.getId());
        org.assertj.core.api.Assertions.assertThat(findCustomer).isNotNull();
        customerRepository.removeCustomer(findCustomer);
        Customer removedCustomer = customerRepository.searchCustomerById(customer.getId());
